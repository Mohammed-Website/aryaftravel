...
const sectionData = [
    {
        title: 'عروض جورجيا',
        image_1: ['مكتب-سياحي-بحريني/عروض-جورجيا/عرض-جورجيا-1.jpg', 'الرحلات الفردية'],
        image_2: ['مكتب-سياحي-بحريني/عروض-جورجيا/عرض-جورجيا-2.jpg', 'رحلات جماعية - إجازة منتصف الفصل السعودي'],
        image_3: ['مكتب-سياحي-بحريني/عروض-جورجيا/عرض-جورجيا-3.jpg', 'رحلات جماعية - إجازة منتصف الفصل السعودي'],
    },
...
let mughader_commentsArray = [
    ...
    },
    {
        ...
        comment: "اشكر طاقم شركة ارياف البحرين على تعاملهم معي يستاهلو كل خير ♥️♥️",
        stars: 5
    },
    {
        profileLetter: "F",
    ...
    },
    {
        ...
        comment: "من افضل واحسن الي تعاملت معهم للامانة ولا غلطة والاسعار حلوه جدا ومعقولة مرا شككككرا  شركة ارياف البحرين للسياحة 💛🙏🏻",
        stars: 5
    },
    {
        profileLetter: "س",
